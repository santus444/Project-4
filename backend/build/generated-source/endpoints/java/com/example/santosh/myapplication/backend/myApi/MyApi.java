 ...
 * on 2015-12-19 at 01:37:34 UTC 
 * Modify at your own risk.
 */

package com.example.santosh.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://gceutraining.appspot.com/_ah/api/";
  ...
  public class GetJokes extends MyApiRequest<com.example.santosh.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJokes() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.santosh.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.santosh.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.santosh.myapplication.backend.myApi.model.MyBean.class);
